...
// ── Pexels CDN helper ──────────────────────────────────────────────────────
// Pexels License: free to use, no attribution required for non-commercial use
const px = (id: number | string, w = 800) =>
  `https://images.pexels.com/photos/${id}/pexels-photo-${id}.jpeg?auto=compress&cs=tinysrgb&w=${w}`

// ── Image bank (curated Pexels IDs) ───────────────────────────────────────
const IMGS = {
  // People / dancers / women in traditional dress
  dancer_vibrant:    px(14106732),  // Indian dancer in vibrant traditional costume
  dancer_jewelry:    px(20134508),  // dancer in traditional clothing & jewelry
  dancer_bharatna:   px(34717651),  // traditional Indian dancer performing
  dancer_graceful:   px(30481578),  // graceful dancer in vibrant attire
  dancer_beach:      px(14106717),  // woman in traditional costume dancing outdoors

  // Pushkar / Camel fair
  camel_man_fair:    px(35026811),  // Rajasthani man with camel at Pushkar Fair
  camel_birds_dawn:  px(21300377),  // birds flying over camels at dawn
  camel_closeup:     px(4455719),   // close-up camel heads
  camel_blue_sky:    px(7567474),   // camels with colorful decorations under blue sky
  camel_decorated:   px(29536909),  // decorated camels at camel fair Rajasthan
  camel_man_rope:    px(21300373),  // man leading camels on rope
  camel_desert_sun:  px(26824002),  // elderly man in traditional dress with camel at sunset

  // Jodhpur / Mehrangarh
  mehrangarh_arch:   px(36470621),  // ornate architecture of Mehrangarh Fort
  mehrangarh_city:   px(797824),    // Mehrangarh Fort + Blue City panorama
  mehrangarh_view:   px(36470626),  // majestic view of Mehrangarh Fort
  jodhpur_palace:    px(36213405),  // Umaid Bhawan Palace Jodhpur

  // Udaipur / Lake Pichola
  udaipur_lake:      px(35455626),  // Lake Palace reflecting on Pichola Lake
  udaipur_arch:      px(35086309),  // Udaipur Palace through historic archway
  udaipur_aerial:    px(35422755),  // aerial view Udaipur
  udaipur_door:      px(33625234),  // traditional ornate door Udaipur

  // Jaisalmer fort / dunes
  jaisalmer_court:   px(33672506),  // intricate sandstone architecture Jaisalmer
  jaisalmer_hall:    px(33726144),  // sandstone courtyard Jaisalmer
  jaisalmer_arches:  px(33726340),  // carved stone arches Jaisalmer
  jaisalmer_stairs:  px(33672501),  // sandstone palace stairs Jaisalmer

  // Jaipur / Rajasthan general
  jaipur_city:       px(16534739),  // Jaipur Pink City
  rajasthan_gen:     px(34548994),  // Rajasthan colorful general scene
}
...
const festivals: Festival[] = [
  ...
  },
  {
    ...
    bestTime: "July – August (Monsoon season, Shravan Tritiya)",
    duration: "3 Days",
    ...
    mapUrl: "https://maps.google.com/?q=Jaipur+Teej+Festival",
  },
  {
    id: 3,
    slug: "karni-mata-fair",
    ...
    bestTime: "March–April & September–October (Navratri periods)",
    duration: "9 Days",
    ...
    location: "Karni Mata Temple, Deshnok, Bikaner, Rajasthan",
    mapUrl: "https://maps.google.com/?q=Karni+Mata+Temple+Deshnok+Bikaner",
  },
  {
    id: 4,
    slug: "ramdevra-fair",
    ...
    bestTime: "August – September (Bhadra Shukla Dvitiya to Ekadashi)",
    duration: "5 Days",
    ...
    location: "Ramdevra Village, near Jaisalmer, Rajasthan",
    mapUrl: "https://maps.google.com/?q=Ramdevra+Jaisalmer+Rajasthan",
  },
  ...
  },
  {
    ...
    bestTime: "January (post-Makar Sankranti)",
    duration: "2 Days",
    ...
    location: "Dr. Karni Singh Stadium, Bikaner, Rajasthan",
    mapUrl: "https://maps.google.com/?q=Bikaner+Camel+Festival+Rajasthan",
  },
  {
    id: 23,
    ...
    mapUrl: "https://maps.google.com/?q=Diggi+Palace+Jaipur",
  },
  {
    id: 24,
    slug: "kite-festival",
    ...
    bestTime: "January 14 (Makar Sankranti)",
    duration: "1 Day",
    ...
    location: "Jaipur Rooftops & Open Grounds, Rajasthan",
    mapUrl: "https://maps.google.com/?q=Jaipur+Kite+Festival",
  },
  ...
  // ───────────────────────────── MUSIC 🎵 ─────────────────────────────
  {
    id: 9,
    slug: "riff-festival",
    name: "RIFF — Rajasthan International Folk Festival",
    city: "Jodhpur",
    date: "2 Oct 2026",
    month: "October",
    category: "Music",
    ...
    bestTime: "October (Gandhi Jayanti week, near full moon)",
    duration: "5 Days",
  ...
  {
    id: 10,
    slug: "udaipur-world-music-festival",
    name: "Udaipur World Music Festival",
    city: "Udaipur",
    date: "20 Feb 2026",
    month: "February",
    category: "Music",
    ...
    location: "Lake Pichola & City Palace, Udaipur, Rajasthan",
    mapUrl: "https://maps.google.com/?q=Udaipur+City+Palace",
  },
  {
    id: 11,
    slug: "folk-night-jaisalmer",
    name: "Folk Night Jaisalmer",
    city: "Jaisalmer",
    date: "21 Dec 2026",
    month: "December",
    category: "Music",
    ...
    bestTime: "December – January (winter evenings)",
    duration: "3 Days",
    ...
    location: "Jaisalmer Fort & Sam Sand Dunes, Jaisalmer, Rajasthan",
    mapUrl: "https://maps.google.com/?q=Jaisalmer+Fort+Rajasthan",
  },
  {
    id: 12,
    slug: "mahindra-blues-festival",
    name: "Sufi Night Jodhpur",
    city: "Jodhpur",
    date: "15 Mar 2026",
    month: "March",
    category: "Music",
    ...
    location: "Toorji Ka Jhalra & Old City Havelis, Jodhpur, Rajasthan",
    mapUrl: "https://maps.google.com/?q=Toorji+Ka+Jhalra+Jodhpur",
  },

  // ───────────────────────────── DANCE 💃 ─────────────────────────────
  {
    id: 13,
    slug: "kalbelia-dance-festival",
    name: "Kalbeliya Dance Festival",
    city: "Jaisalmer",
    date: "18 Nov 2026",
    month: "November",
    category: "Dance",
  ...
  },
  {
    ...
    bestTime: "August (Monsoon season)",
    duration: "2 Days",
    ...
    location: "City Palace Amphitheatre, Udaipur, Rajasthan",
  ...
  },
  {
    ...
    location: "Nagaur Fort Grounds, Nagaur, Rajasthan",
    mapUrl: "https://maps.google.com/?q=Nagaur+Fair+Rajasthan",
  },
  {
    id: 17,
    slug: "baneshwar-fair",
    ...
    bestTime: "January – February (Magh Purnima)",
    duration: "5 Days",
    ...
    location: "Baneshwar Island, Dungarpur, Rajasthan",
    mapUrl: "https://maps.google.com/?q=Baneshwar+Fair+Dungarpur+Rajasthan",
  },
  {
    id: 18,
    slug: "ramdevra-fair-mela",
    name: "Ramdevra Mela",
    city: "Jaisalmer",
    date: "10 Sep 2026",
    month: "September",
    ...
    bestTime: "August – September (Bhadrapada month)",
    duration: "10 Days",
    ...
    location: "Ramdevra, near Pokhran, Jaisalmer, Rajasthan",
    mapUrl: "https://maps.google.com/?q=Ramdevra+Village+Jaisalmer",
  },

  // ───────────────────────────── FOOD 🍛 ─────────────────────────────
  {
    id: 19,
    slug: "rajasthan-food-festival",
    name: "Rajasthan Food Festival",
    city: "Udaipur",
    date: "15 Mar 2026",
    month: "March",
    category: "Food",
    ...
    location: "Fateh Sagar Lake Gardens, Udaipur, Rajasthan",
    mapUrl: "https://maps.google.com/?q=Fateh+Sagar+Lake+Udaipur",
  },
  {
    id: 20,
    slug: "jaipur-street-food-carnival",
    name: "Jaipur Street Food Carnival",
    city: "Jaipur",
    date: "8 Feb 2026",
    month: "February",
    category: "Food",
    ...
    mapUrl: "https://maps.google.com/?q=Jawahar+Kala+Kendra+Jaipur",
  },
  {
    id: 21,
    slug: "udaipur-heritage-food-fest",
    name: "Udaipur Heritage Food Fest",
    city: "Udaipur",
    date: "12 Oct 2026",
    month: "October",
    category: "Food",
    ...
    bestTime: "October (post-monsoon, pleasant evenings)",
    duration: "4 Days",
    ...
    location: "Heritage Havelis & Lake Pichola, Udaipur, Rajasthan",
    mapUrl: "https://maps.google.com/?q=Lake+Pichola+Udaipur",
  },
  ...
  {
    id: 22,
    slug: "craft-mela-jaisalmer",
    name: "Desert Craft Mela",
    city: "Jaisalmer",
    date: "8 Dec 2026",
    month: "December",
    category: "Art & Craft",
    ...
    location: "Jaisalmer Fort Grounds, Jaisalmer, Rajasthan",
    mapUrl: "https://maps.google.com/?q=Jaisalmer+Fort",
  },
]
